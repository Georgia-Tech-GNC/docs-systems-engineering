...
- [ ] **Define repository responsibilities** in `docs/repository-model.md`: what belongs in this club-wide process repository versus what belongs in each program-specific repository.
